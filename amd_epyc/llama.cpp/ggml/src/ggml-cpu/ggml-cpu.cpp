...
#ifdef GGML_NUMA_REPLICATE
    if (strcmp(name, "ggml_backend_cpu_numa_replicate_finalize") == 0) {
        return (void *)ggml_backend_cpu_numa_finalize_load;
    }
    if (strcmp(name, "ggml_backend_cpu_numa_replicate_is_enabled") == 0) {
        return (void *)ggml_backend_cpu_numa_is_enabled;
    }
#endif
